                ...
                <div class="member mt-3">
                  ...
                  <form class="form-inline">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      <div role="input" class="gj-datepicker gj-datepicker-bootstrap gj-unselectable input-group"><input type="text" class="form-control datepicker" id="doePassport" placeholder="DOE Passport" data-type="datepicker" data-guid="5e02c29d-2ac9-78df-a7e3-1b6963f3dab7" data-datepicker="true"><span class="input-group-append" role="right-icon"><button class="btn btn-outline-secondary border-left-0" type="button"><img src="frontend/images/ic_doe.png" alt=""></button></span></div>
                    </div>
...
<div role="picker" type="month" class="gj-picker gj-picker-bootstrap datepicker gj-unselectable" guid="5e02c29d-2ac9-78df-a7e3-1b6963f3dab7" month="3" year="2021" style="display: none;"><div role="body"></div></div></body></html>
