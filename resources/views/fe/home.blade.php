...
<html lang="en">
  ...
  <body>
      ...
      <nav class="row navbar navbar-expand-lg navbar-light bg-white">
        ...
        <div class="collapse navbar-collapse" id="navb">
          <ul class="navbar-nav ml-auto mr-3">
            ...
            <li class="nav-item mx-md-2">
              <a class="nav-link" href="/travel">Paket Travel</a>
            </li>
          ...
          <form class="form-inline d-sm-block d-md-none">
            <a href="/keluar" class="btn btn-login my-2 my-sm-0">
              Keluar
            </a>
          </form>
          <!-- Desktop Button -->
          <form class="form-inline my-2 my-lg-0 d-none d-md-block">
            <a href="/keluar" class="btn btn-login btn-navbar-right my-2 my-sm-0 px-4">
              Keluar
            </a>
          </form>
        </div>
    ...
    <header class="text-center">
      ...
      <a href="/registrasi" class="btn btn-get-started px-4 mt-4">
        Get Started
      </a>
    </header>
    <main>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-12 text-center">
              ...
              <a href="/registrasi" class="btn btn-get-started px-4 mt-4 mx-1">
                Get Started
              </a>
            </div>
          </div>
